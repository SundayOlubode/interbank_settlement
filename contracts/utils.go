...
func (s *SmartContract) emitPaymentEvent(ctx contractapi.TransactionContextInterface, eventName string, details PaymentEventDetails) error {
	evtBytes, err := json.Marshal(details)
	if err != nil {
